...
func main() {
	...
	//
	//fileoperations.WriteFile("data2.txt", string(data))
	//
	//fileoperations.UpdateFile("data.txt", string(data))
	//fileoperations.DeleteFile("data2.txt")
